...
export async function GET(request: Request): Promise<NextResponse> {
  ...
  return proxyForPortal(portal as PortalKey);
}

function proxyForPortal(portal: PortalKey): Promise<NextResponse> {
  const options = {
    path: "/me",
    unauthenticatedMessage: "Sign in to view your profile.",
    unavailableMessage: "Profile details are unavailable.",
  };
