...
export const sharedDocuments: SharedDocument[] = [
  {
    ...
    status: "active", clientDecisionStatus: "pending", clientDecisionAt: null, clientDecisionBy: null, clientDecisionComment: null, recipientEmployeeIds: ["emp-riley"], recipientManagerIds: ["mgr-avery"], recipientTenantAdminIds: ["tenant-admin"], recipientClientIds: ["northstar"], tenantAdminVisible: true, shareReason: null,
  ...
  },
  {
    ...
    status: "active", clientDecisionStatus: "pending", clientDecisionAt: null, clientDecisionBy: null, clientDecisionComment: null, recipientEmployeeIds: [], recipientManagerIds: ["mgr-avery"], recipientTenantAdminIds: ["tenant-admin"], recipientClientIds: ["wellspring"], tenantAdminVisible: true, shareReason: null,
