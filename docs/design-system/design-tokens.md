...
Cards use `--radius-card: 2px` and `--shadow-card: 0 8px 13px -3px rgb(0 0 0 / 0.07)`. Controls use `--radius-control: 4px`; the desktop sidebar and header use `--sidebar-width: 280px` and `--header-height: 80px`.
