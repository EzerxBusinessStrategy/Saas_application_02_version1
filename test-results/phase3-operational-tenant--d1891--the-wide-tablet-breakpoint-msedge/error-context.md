...
- Name: phase3-operational.spec.ts >> tenant reports remain readable at the wide tablet breakpoint
- Location: e2e\phase3-operational.spec.ts:75:5
...
Locator: getByRole('heading', { name: 'Operational reports' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Operational reports' })
