...
- Name: phase3-operational.spec.ts >> employee calendar remains readable on desktop and mobile
- Location: e2e\phase3-operational.spec.ts:57:5
...
Locator: getByRole('table', { name: /delivery calendar for july 2026/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('table', { name: /delivery calendar for july 2026/i })
